...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    KC_GRAVE,       KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_ESCAPE,                                      KC_RIGHT,       KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_EQUAL,
    ...
    KC_LSHIFT,      MT(MOD_LCTL, KC_Z),KC_X,           KC_C,           KC_V,           KC_B,           LM(1,MOD_LSFT),                                 LM(2,MOD_LSFT), KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_RSHIFT,
    LALT(KC_LCTRL), WEBUSB_PAIR,    KC_TRANSPARENT, KC_LALT,        KC_LGUI,                                                                                                        KC_UP,          KC_DOWN,        KC_LBRACKET,    KC_RBRACKET,    MO(1),
